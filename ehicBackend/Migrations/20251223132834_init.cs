        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionsPerExam = table.Column<int>(type: "int", nullable: false),
                    TimeLimit = table.Column<int>(type: "int", nullable: false, defaultValue: 60),
                    PassingPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 80m),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaptismEligibilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BaptismEligibilities_ExamAttempts_ExamAttemptId",
                        column: x => x.ExamAttemptId,
                        principalTable: "ExamAttempts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BaptismEligibilities_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamResponses_AnswerChoices_SelectedAnswerId",
                        column: x => x.SelectedAnswerId,
                        principalTable: "AnswerChoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExamResponses_ExamAttempts_ExamAttemptId",
                        column: x => x.ExamAttemptId,
                        principalTable: "ExamAttempts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Standard Student User", true, "Student" },
                    { 2, "System Administrator", true, "Admin" },
                    { 3, "Exam Creator and Administrator", true, "Instructor" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaptismEligibilities_ExamAttemptId",
                table: "BaptismEligibilities",
                column: "ExamAttemptId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BaptismEligibilities_IsEligible",
                table: "BaptismEligibilities",
                column: "IsEligible");

            migrationBuilder.CreateIndex(
                name: "IX_BaptismEligibilities_UserId",
                table: "BaptismEligibilities",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamAttempts_ExamId_Percentage",
                table: "ExamAttempts",
                columns: new[] { "ExamId", "Percentage" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamResponses_ExamAttemptId_QuestionId",
                table: "ExamResponses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamResponses_SelectedAnswerId",
                table: "ExamResponses",
